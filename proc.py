...
from autologin import get_login_vars
from autologin import send_request
from autologin import REFERRER_LOGIN
from autologin import SESSION_DIR
from autologin import SESSION_FILE_EXT
...
def __main__(argv):
    if len(argv) < 1 and re.match(r'[A-Za-z0-9]{30}', argv[0]) is None:
        print("session file name is not valid.")
    ...
    send_request(login_vars, REFERRER_LOGIN)
